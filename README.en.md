...
[![Codacy](https://img.shields.io/codacy/grade/dc679a17751448628fe6d8ac35e26eed?logo=Codacy&label=Codacy&style=flat-square)](https://app.codacy.com/gh/supremasi/reinstall/dashboard)
[![CodeFactor](https://img.shields.io/codefactor/grade/github/supremasi/reinstall?logo=CodeFactor&logoColor=white&label=CodeFactor&style=flat-square)](https://www.codefactor.io/repository/github/supremasi/reinstall)
[![Lines of Code](https://aschey.tech/tokei/github/supremasi/reinstall?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/aschey/vercel-tokei)
<!-- [![Lines of Code](https://tokei.rs/b1/github/supremasi/reinstall?category=code&label=Lines%20of%20Code&style=flat-square)](https://github.com/XAMPPRocky/tokei_rs) -->
...
[![Donate](https://img.shields.io/badge/Donate-30363D?style=for-the-badge&logo=GitHub-Sponsors&logoColor=#EA4AAA)](https://github.com/sponsors/supremasi)

[![Sponsors](https://raw.githubusercontent.com/supremasi/sponsors/refs/heads/master/sponsors.svg)](https://github.com/sponsors/supremasi)

### Feedback

[![GitHub Issues](https://img.shields.io/badge/GitHub-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/supremasi/reinstall/issues)
...
| <img width="16" height="16" src="https://github.com/supremasi/reinstall/assets/7548515/f74b3d5b-085f-4df3-bcc9-8a9bd80bb16d" /> Kali                                                                                                                                                                                                                                   | Rolling                               | 256 MB    | 1 ~ 1.5 GB ^     |
...
```bash
curl -O https://raw.githubusercontent.com/supremasi/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```

For server inside China:

```bash
curl -O https://cnb.cool/supremasi/reinstall/-/git/raw/main/reinstall.sh || wget -O ${_##*/} $_
```
...
- <https://raw.githubusercontent.com/supremasi/reinstall/main/reinstall.bat>
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/supremasi/reinstall/main/reinstall.bat
```

For server inside China:

```batch
certutil -urlcache -f -split https://cnb.cool/supremasi/reinstall/-/git/raw/main/reinstall.bat
```
...
![Windows Installation](https://github.com/supremasi/reinstall/assets/7548515/07c1aea2-1ce3-4967-904f-aaf9d6eec3f7)
...
![image-name](https://github.com/supremasi/reinstall/assets/7548515/5aae0a9b-61e2-4f66-bb98-d470a6beaac2)
...
Go to <https://github.com/supremasi/reinstall/commits/main> and find the old version’s `commit_id` on the right side.

Replace `xxxxxxxx` in the script below with the `commit_id` of an older version and run the script.

```bash
commit_id=xxxxxxxx
curl -O https://raw.githubusercontent.com/supremasi/reinstall/$commit_id/reinstall.sh || wget -O ${_##*/} $_
...
[![Oracle Cloud](https://github.com/supremasi/reinstall/assets/7548515/8b430ed4-8344-4f96-b4da-c2bda031cc90)](https://www.oracle.com/cloud/)
[![DartNode](https://github.com/supremasi/reinstall/assets/7548515/435d6740-bcdd-4f3a-a196-2f60ae397f17)](https://dartnode.com/)
